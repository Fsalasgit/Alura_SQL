/*
	Para crear una tabla, es necesario primero usar el comando, declarar las variables 
    y la clave primaria.
*/
...
/*
	CREANDO OTRAS ENTIDADES, EN ESTE CASO USAREMOS EL ASISTENTE:
*/

CREATE TABLE productos (
	CODIGO VARCHAR(10) NOT NULL, #Clave primaria siempre not null
...
CREATE TABLE facturas(
    ...
    PRIMARY KEY(NUMERO),
    /*
		Para referenciar la clave forania se debe colocar la sintaxis con la clave y a que tabla hace refencia
        con su variable correspondiente (puede tener otro nombre).
    */
...
/*
 Como faltó definir la clave primaria a codigo tenemos la siguiente solucion
*/
...
INSERT INTO clientes VALUES ('3623344710', 'Marcos Rosas', 'Av. universidad', 'Del Valle',
 'Ciudad de México', 'EM', '22002012', '1995-01-13', 26, 'M', 110000, 220000, 1);
